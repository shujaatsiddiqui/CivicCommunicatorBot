! function (t, e) {
    ...
    return function (t) {
        ...
        var C = Object.prototype.hasOwnProperty,
            ...
            I = /[.?*+^$[\]\\(){}|-]/g,
            P = n(86);
        e.lib = {}, e.lib.mdurl = n(106), e.lib.ucmicro = n(453), e.assign = s, e.isString = o, e.has = i, e.unescapeMd = p, e.unescapeAll = h, e.isValidEntityCode = c, e.fromCodePoint = u, e.escapeHtml = d, e.arrayReplaceAt = a, e.isSpace = v, e.isWhiteSpace = g, e.isMdAsciiPunct = b, e.isPunctChar = y, e.escapeRE = m, e.normalizeReference = _
    }, function (t, e, n) {
        "use strict";
        var r = n(10),
            o = r;
        ...
        ***************************************************************************** */
        ...
        var i = n(5),
            s = n(15),
            a = (n(3), n(143), Object.prototype.hasOwnProperty),
            c = n(141),
            u = {
                key: !0,
                ref: !0,
        ...
        var l = {
            ...
            h = n(79),
            f = n(0);
        n(153), n(154), n(155), n(156), n(157), n(403), n(158), n(408), n(407), n(394), n(151), n(152);
        var d = function (t, e) {
        ...
        var o = r(n(184)),
            ...
            u = n(390),
            l = n(0);
        n(153), n(401), n(402), n(154), n(155), n(156), n(157), n(158), n(404), n(405), n(406), n(395), n(151), n(396), n(398), n(152), n(400);
        var p;
        e.ConnectionStatus = p,
            function (t) {
                ...
                return (0, a.default)(t, [{
                    ...
                    value: function () {
                        var t = this,
                            ...
                            n = this.connectionStatus$.flatMap(function (e) {
                                return e === p.Uninitialized ? (t.connectionStatus$.next(p.Connecting), t.token && t.streamUrl ? (t.connectionStatus$.next(p.Online), l.Observable.of(e)) : t.startConversation().do(function (e) {
                                    t.conversationId = e.conversationId, t.token = t.secret || e.token, t.streamUrl = e.streamUrl, t.referenceGrammarId = e.referenceGrammarId, t.secret || t.refreshTokenLoop(), t.connectionStatus$.next(p.Online)
                                }, function (e) {
                                    t.connectionStatus$.next(p.FailedToConnect)
                                }).map(function (t) {
                                    return e
                                })) : l.Observable.of(e)
                            }).filter(function (t) {
                                return t != p.Uninitialized && t != p.Connecting
                            }).flatMap(function (t) {
                                switch (t) {
                                    case p.Ended:
                                        return l.Observable.throw(d);
                                    case p.FailedToConnect:
                                        return l.Observable.throw(m);
                                    case p.ExpiredToken:
                                    default:
                                        return l.Observable.of(t)
                                }
                            });
                        return e ? n.take(1) : n
                    }
                    ...
                    value: function (t, e) {
                        ...
                        var r = 0,
                            o = null;
                        return function (i) {
                            return i === t && o === i && r >= n ? (r = 0, e) : (r++ , o = i, i)
                        }
                    }
                }, {
                    key: "expiredToken",
                    value: function () {
                        ...
                        t != p.Ended && t != p.FailedToConnect && this.connectionStatus$.next(p.ExpiredToken);
                        var e = this.expiredTokenExhaustion(this.connectionStatus$.getValue());
                        this.connectionStatus$.next(e)
                    }
                }, {
                    key: "startConversation",
                    value: function () {
                        var t = this.conversationId ? "".concat(this.domain, "/conversations/").concat(this.conversationId, "?watermark=").concat(this.watermark) : "".concat(this.domain, "/conversations"),
                            e = this.conversationId ? "GET" : "POST";
                        return l.Observable.ajax({
                            method: e,
                            url: t,
                            timeout: 2e4,
                            headers: (0, i.default)({
                            ...
                            return t.mergeMap(function (t) {
                                return t.status >= 400 && t.status < 600 ? l.Observable.throw(t) : l.Observable.of(t)
                            }).delay(2e4).take(45)
                        })
                    }
                }, {
                    ...
                    value: function () {
                        var t = this;
                        this.tokenRefreshSubscription = l.Observable.interval(9e5).flatMap(function (e) {
                            return t.refreshToken()
                        }).subscribe(function (e) {
                            v.log("refreshing token", e, "at", new Date), t.token = e
                        })
                    }
                }, {
                    key: "refreshToken",
                    value: function () {
                        ...
                        return this.checkConnection(!0).flatMap(function (e) {
                            return l.Observable.ajax({
                                method: "POST",
                                url: "".concat(t.domain, "/tokens/refresh"),
                                timeout: 2e4,
                                headers: (0, i.default)({}, t.commonHeaders())
                            }).map(function (t) {
                                return t.response.token
                            }).retryWhen(function (e) {
                                return e.mergeMap(function (e) {
                                    return 403 === e.status ? (t.expiredToken(), l.Observable.throw(e)) : 404 === e.status ? l.Observable.throw(e) : l.Observable.of(e)
                                }).delay(2e4).take(45)
                            })
                        })
                    }
                    ...
                    key: "reconnect",
                    value: function (t) {
                        this.token = t.token, this.streamUrl = t.streamUrl, this.connectionStatus$.getValue() === p.ExpiredToken && this.connectionStatus$.next(p.Online)
                    }
                }, {
                    key: "end",
                    value: function () {
                    ...
                    value: function () {
                        var t = this;
                        return v.log("getSessionId"), this.checkConnection(!0).flatMap(function (e) {
                            return l.Observable.ajax({
                                method: "GET",
                                ...
                                return t && t.response && t.response.sessionId ? (v.log("getSessionId response: " + t.response.sessionId), t.response.sessionId) : ""
                            }).catch(function (t) {
                                return v.log("getSessionId error: " + t.status), l.Observable.of("")
                            })
                        }).catch(function (e) {
                    ...
                    value: function (t) {
                        var e = this;
                        return "message" === t.type && t.attachments && t.attachments.length > 0 ? this.postMessageWithAttachments(t) : (v.log("postActivity", t), this.checkConnection(!0).flatMap(function (n) {
                            return l.Observable.ajax({
                                method: "POST",
                                url: "".concat(e.domain, "/conversations/").concat(e.conversationId, "/activities"),
                                body: t,
                                timeout: 2e4,
                                headers: (0, i.default)({
                                    "Content-Type": "application/json"
                    ...
                    value: function (t) {
                        ...
                        return this.checkConnection(!0).flatMap(function (t) {
                            ...
                            return l.Observable.ajax({
                                method: "POST",
                                url: "".concat(n.domain, "/conversations/").concat(n.conversationId, "/upload?userId=").concat(s.from.id),
                                body: e,
                                timeout: 2e4,
                                headers: (0, i.default)({}, n.commonHeaders())
                            }).map(function (t) {
                                return t.response.id
                            }).catch(function (t) {
                    ...
                    value: function (t) {
                        ...
                        else if (t.status >= 400 && t.status < 500) return l.Observable.throw(t);
                        return l.Observable.of("retry")
                    }
                }, {
                    key: "catchExpiredToken",
                    value: function (t) {
                        return t === f ? l.Observable.of("retry") : l.Observable.throw(t)
                    }
                }, {
                    key: "pollingGetActivity$",
                    value: function () {
                        var t = this,
                            e = l.Observable.create(function (e) {
                                var n = new u.BehaviorSubject({});
                                n.subscribe(function () {
                                    if (t.connectionStatus$.getValue() === p.Online) {
                                        var r = Date.now();
                                        l.Observable.ajax({
                                            headers: (0, i.default)({
                                                Accept: "application/json"
                                            ...
                                            method: "GET",
                                            url: "".concat(t.domain, "/conversations/").concat(t.conversationId, "/activities?watermark=").concat(t.watermark),
                                            timeout: 2e4
                                        }).subscribe(function (o) {
                                            e.next(o), setTimeout(function () {
                                                return n.next(null)
                                            }, Math.max(0, t.pollingInterval - Date.now() + r))
                                        }, function (r) {
                                            switch (r.status) {
                                                case 403:
                                                    t.connectionStatus$.next(p.ExpiredToken), setTimeout(function () {
                                                        return n.next(null)
                                                    }, t.pollingInterval);
                                                    break;
                                                case 404:
                                                    t.connectionStatus$.next(p.Ended);
                                                    break;
                                                default:
                                                    e.error(r)
                                            }
                    ...
                    value: function (t) {
                        return t.watermark && (this.watermark = t.watermark), l.Observable.from(t.activities)
                    }
                }, {
                    ...
                    value: function () {
                        ...
                        return this.checkConnection().flatMap(function (e) {
                            return t.observableWebSocket().retryWhen(function (e) {
                                return e.delay(t.getRetryDelay()).mergeMap(function (e) {
                    ...
                    value: function () {
                        var t = this;
                        return l.Observable.create(function (e) {
                            v.log("creating WebSocket", t.streamUrl);
                            var n, r = new WebSocket(t.streamUrl);
                            return r.onopen = function (t) {
                                v.log("WebSocket open", t), n = l.Observable.interval(2e4).subscribe(function (t) {
                                    try {
                                        r.send("")
                                    } catch (t) {
                                        v.log("Ping error", t)
                                ...
                                v.log("WebSocket close", t), n && n.unsubscribe(), e.error(t)
                    ...
                    value: function () {
                        ...
                        return this.checkConnection(!0).flatMap(function (e) {
                            return l.Observable.ajax({
                                method: "GET",
                                url: "".concat(t.domain, "/conversations/").concat(t.conversationId, "?watermark=").concat(t.watermark),
                                timeout: 2e4,
                                headers: (0, i.default)({
                                    Accept: "application/json"
                                }, t.commonHeaders())
                                ...
                                return e.mergeMap(function (e) {
                                    ...
                                    else if (404 === e.status) return l.Observable.throw(d);
                                    return l.Observable.of(e)
                                }).delay(2e4).take(45)
                            })
                        })
                    }
                    ...
                    value: function () {
                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
                            e = "directlinejs";
                        return t && (e += "; ".concat(t)), "".concat("DirectLine/3.0", " (").concat(e, ")")
                    }
                }]), t
            }();
        e.DirectLine = g
        ...
        "use strict";
        t.exports.encode = n(288), t.exports.decode = n(287), t.exports.format = n(289), t.exports.parse = n(290)
    }, function (t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
                ...
                var s = e.displayName || e.name || "Component",
                    ...
                    h = function (s) {
                        ...
                        return i(p, s), p.prototype.getChildContext = function () {
                            ...
                            return f()(I, "To access the wrapped instance, you need to specify { withRef: true } in the options argument of the " + w + "() call."), this.wrappedInstance
                            ...
                            if (!(I || k || this.propsMode && this.subscription)) return t;
                            var e = g({}, t);
                            return I && (e.ref = this.setWrappedInstance), k && (e[k] = this.renderCount++), this.propsMode && this.subscription && (e[D] = this.subscription), e
        ...
        var r = n(56),
            ...
            i = n(212),
            s = "".startsWith;
        r(r.P + r.F * n(202)("startsWith"), "String", {
        ...
        var a = n(39);
        e.Speech = a.Speech, n(178), n(177), n(176)
    }, function (t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        (function (e) {
            t.exports = e.AdaptiveCards = n(291)
        }).call(e, n(38))
    }, function (t, e, n) {
        "use strict";
        ...
        t.exports = function (t) {
            var e = {};
            e.src_Any = n(172).source, e.src_Cc = n(170).source, e.src_Z = n(171).source, e.src_P = n(86).source, e.src_ZPCc = [e.src_Z, e.src_P, e.src_Cc].join("|"), e.src_ZCc = [e.src_Z, e.src_Cc].join("|");
        ...
        "use strict";
        e.parseLinkLabel = n(246), e.parseLinkDestination = n(245), e.parseLinkTitle = n(247)
    }, function (t, e, n) {
        "use strict";
        var r = n(2).isSpace,
            o = n(2).unescapeAll;
        ...
        var o = n(60),
            i = [
                ["table", n(267), ["paragraph", "reference"]],
                ["code", n(257)],
                ["fence", n(258), ["paragraph", "reference", "blockquote", "list"]],
                ["blockquote", n(256), ["paragraph", "reference", "list"]],
                ["hr", n(260), ["paragraph", "reference", "blockquote", "list"]],
                ["list", n(263), ["paragraph", "reference", "blockquote"]],
                ["reference", n(265)],
                ["heading", n(259), ["paragraph", "reference", "blockquote"]],
                ["lheading", n(262)],
                ["html_block", n(261), ["paragraph", "reference", "blockquote"]],
                ["paragraph", n(264)]
            ];
        ...
        }, r.prototype.State = n(266), t.exports = r
    }, function (t, e, n) {
        "use strict";
        ...
        }, r.prototype.State = n(274), t.exports = r
    }, function (t, e, n) {
        "use strict";
        ...
        var o = n(60),
            i = [
                ...
                ["escape", n(279)],
                ["backticks", n(276)],
                ["strikethrough", n(105).tokenize],
                ["emphasis", n(104).tokenize],
                ["link", n(282)],
                ["image", n(281)],
                ["autolink", n(275)],
                ["html_inline", n(280)],
            ...
            s = [
                ["balance_pairs", n(277)],
                ["strikethrough", n(105).postProcess],
                ["emphasis", n(104).postProcess],
                ["text_collapse", n(286)]
            ];
        ...
        }, r.prototype.State = n(284), t.exports = r
    }, function (t, e, n) {
        "use strict";
        t.exports = {
            options: {
        ...
        "use strict";
        var r = n(243),
            o = n(103).HTML_OPEN_CLOSE_TAG_RE,
            i = [
        ...
        var s = n(2).isSpace;
        t.exports = function (t, e, n, a) {
            var c, u, l, p, h, f, d, m, v, g, y, b, _, C, w, x, k, S, E, A, T, O, I, P, D, M, N, R, L = !1,
                j = !0;
            if (t.sCount[e] - t.blkIndent >= 4) return !1;
            if (a && "paragraph" === t.parentType && t.tShift[e] >= t.blkIndent && (L = !0), (I = o(t, e)) >= 0) {
                if (d = !0, D = t.bMarks[e] + t.tShift[e], _ = Number(t.src.substr(D, I - D - 1)), L && 1 !== _) return !1
            } else {
            ...
            for (y = t.tokens.length, d ? (R = t.push("ordered_list_open", "ol", 1), 1 !== _ && (R.attrs = [
                ["start", _]
            ])) : R = t.push("bullet_list_open", "ul", 1), R.map = g = [e, 0], R.markup = String.fromCharCode(b), w = e, P = !1, N = t.md.block.ruler.getRules("list"), E = t.parentType, t.parentType = "list"; w < n;) {
                for (O = I, C = t.eMarks[w], f = x = t.sCount[w] + I - (t.bMarks[e] + t.tShift[e]); O < C && (c = t.src.charCodeAt(O), s(c));) 9 === c ? x += 4 - (x + t.bsCount[w]) % 4 : x++ , O++;
        ...
        var P = function () {
            function t(t, e) {
                var n = this;
                this._style = "button", this._element = null, this._state = I.Normal, this.onClick = null, this._action = t, this._style = e, this._element = document.createElement("button"), this._element.type = "button", this._element.style.overflow = "hidden", this._element.style.whiteSpace = "nowrap", this._element.style.textOverflow = "ellipsis", this._element.onclick = function (t) {
                    n.click()
                }, this.updateCssStyle()
            }
            ...
            return t.prototype.hideActionCardPane = function () {
                ...
                if (t.action instanceof F)
                    if ("popup" == Z.actions.showCard.actionMode) t.action.execute();
                        ...
                        for (var e = 0; e < this._actionButtons.length; e++) this._actionButtons[e].state = I.Normal;
                        this.hideActionCardPane()
                    } else {
                        for (var e = 0; e < this._actionButtons.length; e++) this._actionButtons[e] !== t && (this._actionButtons[e].state = I.Subdued);
                        t.state = I.Expanded, this.showActionCardPane(t.action)
                    } else {
                    for (var e = 0; e < this._actionButtons.length; e++) this._actionButtons[e].state = I.Normal;
                ...
                if (Z.actions.preExpandSingleShowCardAction && 1 == n && this.items[0] instanceof F && o(this.items[s], r)) this.showActionCardPane(this.items[0]), this._renderedActionCount = 1;
                    ...
                    for (var s = 0; s < n; s++)
                        if (o(this.items[s], r)) {
                            var a = new P(this.items[s], this.actionStyle);
        ...
        var L = {
            ...
            extractEvents: function (t, e, n, i) {
                ...
                if (o(c) ? N ? s = l : a = p : I(c) ? R ? s = b : (s = v, a = m) : g(c) && (s = y), s) {
                    var u = s(t, e, n);
                    if (u) {
                        return r(u, n, i)
                    }
        ...
        function f(t) {
            X.call(J, t) || (Z.test(t) || v("65", t), J[t] = !0)
        }
            ...
            mountComponent: function (t, e, n, r) {
                ...
                switch (this._tag) {
                    ...
                    case "option":
                        ...
                        break;
                    case "select":
                        P.mountWrapper(this, i, e), i = P.getHostProps(this, i), t.getReactMountReady().enqueue(p, this);
                        break;
                    case "textarea":
        ...
        var a = (n(138), Object.assign || function (t) {
            for (var e = 1; e < arguments.length; e++) {
                var n = arguments[e];
                for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (t[r] = n[r])
            }
        ...
        "use strict";
        e.Any = n(172), e.Cc = n(170), e.Cf = n(452), e.P = n(86), e.Z = n(171)
    }])
});